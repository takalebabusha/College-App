...
public class TeacherAdapter extends RecyclerView.Adapter<TeacherAdapter.TeacherViewAdapter> {
    ...
    public TeacherAdapter(@android.support.annotation.NonNull List<TeacherData> list, @android.support.annotation.NonNull Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull TeacherViewAdapter holder, int position) {
        ...
        holder.update.setOnClickListener(view -> Toast.makeText(context, "Update Teacher", Toast.LENGTH_SHORT).show());
